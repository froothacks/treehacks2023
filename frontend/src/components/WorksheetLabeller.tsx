...
import { Button, Image as ChakraImage, Spinner } from "@chakra-ui/react";
    ...
    <div>
      {ratio ? (
        <div>
          ...
          <Button colorScheme={"green"} onClick={addBox}>
            Add Box
          </Button>
          <Button variant={"outline"} colorScheme={"red"} onClick={deleteBox}>
            Delete
          </Button>
          <Button
            colorScheme={"green"}
            onClick={() => submit(boxes, worksheetId)}
          >
            Accept
          </Button>
        </div>
